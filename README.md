...
GAMA extends SIRIUS LOCAL AI into the mobile world, enabling:

- offline schoolwork assistance  
- offline OCR and image understanding  
...
# 📝 License
MIT License (same as SIRIUS LOCAL AI ecosystem)
